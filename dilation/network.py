...
def make_weighted_softmax_loss(bottom, label, nout, weights):
   return L.WeightedSoftmaxWithLoss(bottom,label, loss_param=dict(ignore_label=255,normalization=P.Loss.VALID), softmax_param=dict(num_classes=nout, class_weights=weights))
