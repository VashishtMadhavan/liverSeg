...
def make_frontend_vgg(options, is_training, isWeighted=False):
...
def process_options(options):
    ...
    assert os.path.exists(options.ratio_file), options.ratio_file + "does not exist"
